                ...
                <div class="search-engine-int">
                    ...
                    <div class="search-eg-table">
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td><img class="search-engine-img" src="<?= base_url('assets/notika/img/search-engines/google.png') ?>" alt="">Google</td>
                                    <td class="text-right">3831 <i class="notika-icon notika-up-arrow"></i></td>
                                </tr>
                                <tr>
                                    <td><img class="search-engine-img" src="<?= base_url('assets/notika/img/search-engines/bing.png') ?>" alt="">Bing</td>
                                    <td class="text-right">2123 <i class="notika-icon notika-down-arrow"></i></td>
                                </tr>
                                <tr>
                                    <td><img class="search-engine-img" src="<?= base_url('assets/notika/img/search-engines/baidu.png') ?>" alt="">Baidu</td>
                                    <td class="text-right">4375 <i class="notika-icon notika-up-arrow"></i></td>
                                </tr>
                                <tr>
                                    <td><img class="search-engine-img" src="<?= base_url('assets/notika/img/search-engines/yahoo.png') ?>" alt="">Yahoo</td>
                                    <td class="text-right">4020 <i class="notika-icon notika-up-arrow"></i></td>
                                </tr>
                                <tr>
                                    <td><img class="search-engine-img" src="<?= base_url('assets/notika/img/search-engines/duckduckgo.png') ?>" alt="">DuckDuckGo</td>
                                    <td class="text-right">2064 <i class="notika-icon notika-up-arrow"></i></td>
                                </tr>
                                <tr>
                                    <td class="analysis-rd-mg"><img class="search-engine-img" src="<?= base_url('assets/notika/img/search-engines/yandex.png') ?>" alt="">Yandex</td>
