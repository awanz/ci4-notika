...
<body>
    ...
    <div class="login-content">
        ...
        <div class="nk-block toggled" id="l-login">
            <div class="nk-form">
                ...
                <a href="<?= base_url('dashboard') ?>" class="btn btn-login btn-success btn-float"><i class="notika-icon notika-right-arrow right-arrow-ant"></i></a>
            </div>
    ...
    <!-- Login JS
		============================================ -->
    <script src="<?= base_url('assets/notika/js/login/login-action.js') ?>"></script>
    <!-- plugins JS
		============================================ -->
